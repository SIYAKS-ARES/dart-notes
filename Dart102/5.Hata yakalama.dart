...
void returnEdecek() {
  try {
    ...
    print(
        'Ekran temizleniyor.'); //Bu blok hata yakalansa da yakalanmasa da çalışır.
  }
  print(
      'Herşeyden sonra bu satır da çalışır mı?'); /*Return edeceği zaman çalışmaz ama 'Ekran temizleniyor'
